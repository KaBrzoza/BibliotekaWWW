    ...
    <main>
        <article>
            <section>
                <div class="scalebook">
                    <section>
                        <img src="../img/homo-deus.jpg" alt="Homo deus krórka historia jutra.">
                    </section>
                </div>
            </section>
            <section>
               <div class="desc">
                <?php
                    ...
                    $kw1 = "SELECT opis FROM ksiazka WHERE id = 3";
        ...
        <div id="kom">
            ...
            <?php
                ...
                if(isset($_POST['komentarz'])){
                    ...
                    $kw = "INSERT INTO komentarze (id, konta_id, ksiazka_id, odpowiedz) VALUES (NULL, '1', '3','".$komentarz."')";
            ...
            <?php
                $kw2 = "SELECT komentarze.id, odpowiedz, nick FROM konta INNER join komentarze on konta_id = konta.id where ksiazka_id = 3";
