    ...
    <main>
        <article>
            <section>
                <div class="scalebook">
                    <section>
                        <img src="../img/rozmyslania.jpg" alt="Rozmyślania. Do samego siebie">
                    </section>
                </div>
            </section>
            <section>
               <div class="desc">
                <?php
                    ...
                    $kw1 = "SELECT opis FROM ksiazka WHERE id = 1";
        ...
        <div id="kom">
            ...
            <?php
                ...
                if(isset($_POST['komentarz'])){
                    ...
                    $kw = "INSERT INTO komentarze (id, konta_id, ksiazka_id, odpowiedz) VALUES (NULL, '1', '1','".$komentarz."')";
            ...
            <?php
                $kw2 = "SELECT komentarze.id, odpowiedz, nick FROM konta INNER join komentarze on konta_id = konta.id where ksiazka_id = 1";
